    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-card rounded-lg p-6 border">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold text-card-foreground">{dashboardData?.stats?.totalControls ?? 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg p-6 border">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold text-card-foreground">{dashboardData?.stats?.completedControls ?? 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg p-6 border">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold text-card-foreground">{dashboardData?.stats?.pendingEvidences ?? 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg p-6 border">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold text-card-foreground">{dashboardData?.stats?.upcomingAudits ?? 0}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <CreateAssessmentModal
          ...
          onCreate={async ({ title, col, dueIn, created, startDate }) => {
            const createdItem = await (await import('../services/assessments')).createAssessment({ title, col, dueIn, created, startDate });
