...
exports.frameworkStructures = void 0;
exports.frameworkStructures = {
    'PCI DSS 4.0': {
        code: 'pci-dss-4-0',
        parts: [
            {
                ...
                sections: [
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                fields: [
                                    { id: 'providedConsultationForCustomizedApproach', type: 'radio', label: 'Indicate whether the QSA Company provided any consultation on the development or implementation of controls used for the Customized Approach.', options: ['Yes', 'No'] },
                            ...
                            },
                            {
                                ...
                                fields: [
                                    { id: 'subcontractorsUsed', type: 'radio', label: 'Indicate whether any assessment activities were subcontracted to another Assessor Company.', options: ['Yes', 'No'] },
                                    { id: 'subcontractorDetails', type: 'textarea', label: 'If yes, identify the Assessor Company(s) utilized during the assessment.' }
                                ]
                            },
                            {
                                id: '1.6',
                            ...
                            },
                            {
                                ...
                                fields: [
                                    { id: 'assessmentCompletion', type: 'radio', label: 'Indicate whether a full or partial assessment was completed.', options: ['Full Assessment', 'Partial Assessment'] },
                                    { id: 'overallAssessmentResult', type: 'radio', label: 'Overall Assessment Result (Select only one)', options: ['Compliant', 'Non-Compliant', 'Compliant but with Legal Exception'] }
                                ]
                            },
                            {
                                id: '1.8',
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { id: '4.6', number: '4.6', label: 'In-Scope Locations/Facilities',
                                fields: [
                                    { id: 'locNote', type: 'heading', label: 'Identify and provide details for all types of physical locations/facilities (for example, retail locations, corporate offices, data centers, call centers and mail rooms) in scope. Add rows as needed.' },
                            ...
                            { id: '4.7', number: '4.7', label: 'In-Scope System Component Types',
                                fields: [
                                    { id: 'compNote', type: 'heading', label: 'Identify all types of system components in scope. Add rows as needed.' },
                                    { id: 'componentTypes', type: 'table-list', label: 'System Component Types', minRows: 4, columns: [
